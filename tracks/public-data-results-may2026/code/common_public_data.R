# common_public_data.R  -- by-size variant
#
...
#   tracks/public-data-results-may2026/
#       code/common_public_data.R              # this file
...
track_dir    <- "tracks/public-data-results-may2026"
...
base_controls <- c(
  ...
  "hhi_lag1", "no_bank_zip_lag1",
  "n_large_banks_zip_lag1",
  "bank_in_state_lag1", "log_n_branches_lag1", "share_bzt_lag1"
)
