...
#
# Output: tracks/first-draft-may2026/data/bank_year_zip_panel_<DATE>.rds
# =============================================================================
...
# Built by: tracks/first-draft-may2026/code/sample-construction/00a_build_zip_population_density_20260508.R
zip_pop_density_path   <- "data/raw/zip_population_density.rds"

# Built by: tracks/first-draft-may2026/code/sample-construction/00b_build_zip_year_acs_panel_20260508.R
zip_acs_panel_glob     <- "data/constructed/zip_year_acs_panel_*.rds"

start_year                   <- 2009L
end_year                     <- 2026L
large_bank_threshold_dollars <- 1e9             # $1B max-asset cutoff (was 50e9)
out_dir                      <- "tracks/first-draft-may2026/data"
